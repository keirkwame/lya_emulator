...
def generate_likelihood_class(testdir, emudir, simulation_sub_directory=None, mean_flux_label='c', max_z = 4.2, rescale_data_error=False, fix_error_ratio=False, error_ratio=100., optimise_GP=True):
    ...
    return LikelihoodClass(basedir=emudir, datadir=testdir+simulation_sub_directory, mean_flux=mean_flux_label, max_z=max_z, rescale_data_error=rescale_data_error, fix_error_ratio=fix_error_ratio, error_ratio=error_ratio, optimise_GP=optimise_GP)
