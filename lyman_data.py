...
class BOSSData(SDSSData):
    ...
    def __init__(self, datafile=os.path.expanduser("~/Software/lya_emulator/data/boss_dr9_data/table4a.dat"), covardir=os.path.expanduser("~/Software/lya_emulator/data/boss_dr9_data")): #Fix absolute paths!
        # Read SDSS best-fit data.
        # Contains the redshift wavenumber from SDSS
        # See Readme file.
