...
if __name__ == "__main__":
    emulator_base_directory = ['/share/rcifdata/keir/Simulations', '/share/data2/keir/Simulations', '/share/data2/keir/Simulations']
    emulator_names = ['nCDM_convergence_896', 'nCDM_convergence_768_WDM', 'nCDM_convergence_512_256']
    ...
    savefile = os.path.join(emulator_base_directory[0], emulator_names[0], 'flux_power_convergence_896.pdf')
