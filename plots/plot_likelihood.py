...
def single_likelihood_plot(sdir, like, savedir, prior_function='uniform', plot=True, t0=1., true_parameter_values=None,
    ...
    filename_suffix = '_referee_test_mock90' #'_emu50_512_test_ULA_diag_emu_input_IGM_3000' #TDR_u0_3000_convex_hull_omega_m_fixed_tau_Planck_T0_tighter_prior_no_jump_Tu0_Tu0CH_0_T012_g08_u012_18' #'_mf_free_prior_measured_TDR_gamma_power_law_T0_prior_3000'
    ...
    if not os.path.exists(chainfile):
        ...
        like.do_sampling(chainfile, datadir=datadir, nwalkers=150, burnin=300, nsamples=300,
                         while_loop=False, k_data_max=10.**(-1.05), include_emulator_error=True, pool=None) #'use_real_data'
