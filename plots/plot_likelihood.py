...
def run_likelihood_test(testdir, emudir, savedir=None, prior_function='uniform', prior_function_args=None,
    ...
    like = likeh.BaryonDarkMatterFixedMassLikelihoodClass(basedir=emudir, log_mass_DM_eV=5., mean_flux=mean_flux_label,
                                 ...
                                 flux_power_savefile='emulator_flux_vectors2.hdf5',
...
def single_likelihood_plot(sdir, like, savedir, plot=True, t0=1., true_parameter_values=None,
    ...
    filename_suffix = '_fixed_mass_5_30000'
