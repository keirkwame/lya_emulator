...
if __name__ == "__main__":
    ...
    emudir = sim_rootdir + '/refinement_tight' #'/hires_s8' #'/hot_cold'
    ...
    generate_emulator_submissions(emudir, new_simulation_parameters, emulator_parameter_limits, hypatia_queue='cores40', refinement=True)
